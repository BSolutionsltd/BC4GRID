...
const contractDetailsJson = [
    {
        ...
        "networks": {
            "11155111": {
                "address": "0x51B38E508d4A2218dB81768c1b0b36e94E3d02D0"
            }
        }
    },
	{
		...
		"abi": [
			{
				"inputs": [
					{
						"internalType": "address",
						"name": "TokenDispenserContractAddress",
						"type": "address"
					}
				],
				"stateMutability": "nonpayable",
        ...
        "networks": {
            "11155111": {
                "address": "0x18e4A03fE5eCcc59F25D505a5798b255fFB8d62A"
            }
        }
	}
];
...
async function init() {
    ...
    try {
		...
		UI.setInnerHtml('base-fee', await window.ethExp.getBaseFeePerGas());
...
function getPriorityFee() {
    var priorityFee = document.getElementById('priority-fee').value;

    if (isNaN(priorityFee)) return 0;
